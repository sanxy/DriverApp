...
//                    else if (getIntent().hasExtra("CheckFor") && DELIVERY_VERIFICATION_METHOD.equalsIgnoreCase("code")) {
//                        enableConfirmationView();
//                    }
//                    else if (getIntent().hasExtra("CheckFor") && DELIVERY_VERIFICATION_METHOD.equalsIgnoreCase("None")) {
////                        enableConfirmationView();
//                        Toast.makeText(getActContext(), "No code view", Toast.LENGTH_SHORT).show();
//                        enableNoCodeView();
//                    }
                    else {
                        resetView();
