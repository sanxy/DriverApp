...
public class CardPaymentActivity extends AppCompatActivity {
    ...
    public void openAddCardFrag(String mode) {
        ...
        if (APP_PAYMENT_METHOD.equalsIgnoreCase("Flutterwave")) {
            ...
            String publicKey = generalFunc.getJsonValueStr("FLUTTERWAVE_PUBLIC_KEY", userProfileJsonObj);
            RaveConstants.PUBLIC_KEY = publicKey;
            String encryptKey = generalFunc.getJsonValueStr("FLUTTERWAVE_ENCRYPTION_KEY", userProfileJsonObj);
            RaveConstants.ENCRYPTION_KEY = encryptKey;
            String stagingURL = generalFunc.getJsonValueStr("FLUTTERWAVE_STAGING_URL", userProfileJsonObj);
            RaveConstants.STAGING_URL = stagingURL;
            String defaultAmount = generalFunc.getJsonValueStr("FLUTTERWAVE_CHARGE_AMOUNT", userProfileJsonObj);


            new RavePayManager(this).setAmount(Double.parseDouble(defaultAmount))
                    .setCountry(generalFunc.getJsonValueStr("vCountry", userProfileJsonObj))
                    .setCurrency(generalFunc.getJsonValueStr("vFlutterwaveCurrency", userProfileJsonObj))
                    .setEmail(generalFunc.getJsonValueStr("vEmail", userProfileJsonObj))
                    .setfName(generalFunc.getJsonValueStr("vName", userProfileJsonObj))
                    .setlName(generalFunc.getJsonValueStr("vLastName", userProfileJsonObj))
                    .setNarration(null)
